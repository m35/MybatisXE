...
public class CommonDAOInterfacePlugin extends PluginAdapter {
    ...
    public List<GeneratedJavaFile> contextGenerateAdditionalJavaFiles(IntrospectedTable introspectedTable) {
        ...
        if (StringUtility.stringHasValue(daoTargetPackage)) {
            ...
            mapperInterface.addJavaDocLine(" * Public base class for DAOs; automatically generated by MyBatis Generator-do not modify.");
            mapperInterface.addJavaDocLine(" * @param <Model> The Model Class This is a generic type, not a model class.");
            mapperInterface.addJavaDocLine(" * @param <PK> The Primary Key Class If there is no primary key, a Model can be used to bypass it; if there are multiple primary keys, a Key class is used.");
    ...
    public boolean clientGenerated(Interface interfaze, IntrospectedTable introspectedTable) {
        ...
        interfaze.addJavaDocLine(" * " + interfaze.getType().getShortName() + " Inherit from a base class");
        interfaze.addJavaDocLine(" */");
